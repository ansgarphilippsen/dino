...
int guiInitRGB(void);
int guiInitVisual(void);
int guiInitStereo(void);
...
void guiCreateMenu(void);
void guiMenuHelp(Widget, caddr_t, caddr_t);
int guiDialboxInit(void);
int guiSpaceballInit(void);
void guiExtensionHandler(Widget w, XtPointer client_data, XEvent *event);
int guiStereo(int mode);
int guiCreateWin(void);
