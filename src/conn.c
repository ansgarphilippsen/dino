...
static struct CONN_DEF_ENTRY def_entry[]={
  {"Alanine","ALA",'A',
   {"N","CA","C","O","CB","OXT"},6,
   {{-2,1}, {1,2}, {2,3}, {3,4}, {2,5}, {3,-3}, {6,-4}},7,
   {0, 0, 0, 0, 0, 0},6
  },
  {"Cystein","CYS",'C',
   {"N","CA","C","O","CB","SG","OXT"},7,
   {{-2,1},{1,2},{2,3},{3,4},{2,5},{5,6},{3,-3},{8,-4}},8,
   {0, 0, 0, 0, 0, 0, 0},7
  },
  {"Aspartate","ASP",'D',
   {"N","CA","C","O","CB","CG","OD1","OD2","OXT"},9,
   {{-2,1},{1,2},{2,3},{3,4},{2,5},{5,6},{6,7},{6,8},{3,-3},{9,-4}},10,
   {0, 0, 0, 0, 0, 0, 0, 0, 0},9
  },
  {"Glutamate","GLU",'E',
   {"N","CA","C","O","CB","CG","CD","OE1","OE2","OXT"},10,
   {{-2,1},{1,2},{2,3},{3,4},{2,5},{5,6},{6,7},{7,8},{7,9},{3,-3},{10,-4}},11
  },
  {"Phenylalanine","PHE",'F',
   {"N","CA","C","O","CB","CG","CD1","CD2","CE1","CE2","CZ","OXT"},12,
   {{-2,1},{1,2},{2,3},{3,4},{2,5},{5,6},{6,7},{6,8},{7,9},{8,10},{9,11},{10,11},{3,-3},{12,-4}},14
  },
  {"Glycin","GLY",'G',
   {"N","CA","C","O","OXT"},5,
   {{-2,1},{1,2},{2,3},{3,4},{3,-3},{5,-4}},6
  },
  {"Histidine","HIS",'H',
   {"N","CA","C","O","CB","CG","ND1","CD2","CE1","NE2","OXT"},11,
   {{-2,1},{1,2},{2,3},{3,4},{2,5},{5,6},{6,7},{6,8},{7,9},{8,10},{9,10},{3,-3},{11,-4}},13
  },
  {"Isoleucine","ILE",'I',
   {"N","CA","C","O","CB","CG1","CG2","CD1","OXT"},9,
   {{-2,1},{1,2},{2,3},{3,4},{2,5},{5,6},{5,7},{6,8},{3,-3},{9,-4}},10
  },
  {"Lysin","LYS",'K',
   {"N","CA","C","O","CB","CG","CD","CE","NZ","OXT"},10,
   {{-2,1},{1,2},{2,3},{3,4},{2,5},{5,6},{6,7},{7,8},{8,9},{3,-3},{10,-4}},11
  },
  {"Leucin","LEU",'L',
  ...
  {"Methionine","MET",'M',
   ...
   {{-2,1},{1,2},{2,3},{3,4},{2,5},{5,6},{6,7},{7,8},{3,-3},{10,-4}},10
  },
  {"Asparagine","ASN",'N',
  ...
  {"Proline","PRO",'P',
   ...
   {{-2,1},{1,2},{2,3},{3,4},{2,5},{5,6},{6,7},{7,1},{3,-3},{8,-4}},10
  },
  {"Glutamine","GLN",'Q',
  ...
  {"Arginine","ARG",'R',
   ...
   {{-2,1},{1,2},{2,3},{3,4},{2,5},{5,6},{6,7},{7,8},{8,9},{9,10},{9,11},{3,-3},{12,-4}},13
  },
  {"Serine","SER",'S',
   {"N","CA","C","O","CB","OG","OXT"},7,
   {{-2,1},{1,2},{2,3},{3,4},{2,5},{5,6},{3,-3},{7,-4}},8
  },
  {"Threonine","THR",'T',
   {"N","CA","C","O","CB","OG1","CG2","OXT"},8,
   {{-2,1},{1,2},{2,3},{3,4},{2,5},{5,6},{5,7},{3,-3},{8,-4}},9
  },
  {"Valine","VAL",'V',
  ...
  {"Tryptophan","TRP",'W',
   ...
   {{-2,1},{1,2},{2,3},{3,4},{2,5},{5,6},{6,7},{6,8},{7,9},{8,10},{9,10},{8,11},{10,12},{11,13},{12,14},{13,14},{3,-3},{15,-4}},18
  },
  {"Tyrosin","TYR",'Y',
   {"N","CA","C","O","CB","CG","CD1","CD2","CE1","CE2","CZ","OH","OXT"},13,
   {{-2,1},{1,2},{2,3},{3,4},{2,5},{5,6},{6,7},{6,8},{7,9},{8,10},{9,11},{10,11},{11,12},{3,-3},{13,-4}},15
  },
  {"Adenosin","A",' ',
